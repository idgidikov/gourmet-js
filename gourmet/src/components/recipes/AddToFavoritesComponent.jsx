...
function AddToFavoritesComponent(cocktailId) {
    ...
    return (
        <div className="add-to-favorites" onClick={addToFavorites}>
            <svg xmlns="http://www.w3.org/2000/svg" fill={userData?.favorites?.cocktails[cocktailId] ? 'none' : 'red'} viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6">
