        ...
        <div className="navbar bg-base-100">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal p-0">
                    <li><Link to='/blog-posts/last-added' className="btn mr-5">Last Added</Link></li>
                    <li><Link to='/blog-posts/most-commented' className="btn mr-5">Most Commented</Link></li>
                    <li><Link to='/blog-posts/most-liked' className="btn mr-5">Most Liked</Link></li>
                </ul>
            </div>
