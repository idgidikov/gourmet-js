export const API_KEYS= {
    cocktail : 'https://www.thecocktaildb.com/api/json/v1/1/search.php?f=a',
    meal : 'https://www.themealdb.com/api/json/v1/1/search.php?f=b',
    cocktailId : 'https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=',
